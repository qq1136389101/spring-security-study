...
import com.github.weichun97.sms.controller.ValidateController;
import com.github.weichun97.sms.exception.ValidateCodeException;
import com.github.weichun97.sms.pojo.SmsCode;
...
public class SmsCodeFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
        ...
        if (StrUtil.equalsIgnoreCase("/smsLogin", httpServletRequest.getRequestURI())
    ...
    private void validateSmsCode(ServletWebRequest servletWebRequest) throws ServletRequestBindingException {
        ...
        if (!StrUtil.equalsIgnoreCase(codeInSession.getCode(), smsCodeInRequest)) {
